    ...
    <div className="py-20">
      <div className="container mx-auto px-4">
        <div className="text-center mb-5">
          <h6 className="text-lg font-semibold">Experience Comfort and Luxury</h6>
          ...
          {[room1, room2, room3].map((room, index) => (
            <div key={index} className="relative overflow-hidden group">
              <img
                src={room}
                alt={`Room ${index + 1}`}
                className="w-full h-auto transition-transform duration-400 ease-in-out transform group-hover:scale-105"
              />
              <div className="absolute inset-0 flex items-center justify-center group-hover:opacity-100 opacity-0 transition-all duration-500 ease-in-out bg-black bg-opacity-50">
